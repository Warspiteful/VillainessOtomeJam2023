...
label choice2_done:
    ...
    show d sb
    "I walk around the tea room, taking in every bit of detail."
    "Fantasy manhwa tend to have a lot of detail and 'My Magical Kindness Made the Cold Prince Fall in Love!!' was no exception."
    show d oh
    ...
    show o smile nor
    show d gloom
    "It must be a surprise. [mcname]'s reputation was already less than ideal from the get go."
    "Besides the rumors she spread, she was known to be mean-spirited."
